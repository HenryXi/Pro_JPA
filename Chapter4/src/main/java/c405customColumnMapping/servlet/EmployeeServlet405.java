package c405customColumnMapping.servlet;
...
import c405customColumnMapping.model.stateless.EmployeeService405;

public class EmployeeServlet405 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee405 emp = service.createEmployee(
            ...
            Collection<Employee405> emps = service.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee405 emp : emps) {
                    out.println(emp + "<br/>");
                }
            }
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet405\" method=\"POST\">");
