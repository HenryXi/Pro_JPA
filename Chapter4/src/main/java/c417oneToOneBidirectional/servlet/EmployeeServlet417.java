package c417oneToOneBidirectional.servlet;
...
import c417oneToOneBidirectional.model.stateless.EmployeeService417;
import c417oneToOneBidirectional.model.stateless.ParkingSpaceService417;

public class EmployeeServlet417 extends HttpServlet {
    ...
    @EJB
    EmployeeService417 empService;
    @EJB
    ParkingSpaceService417 pSpaceService;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee417 emp = empService.createEmployee(
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet417\" method=\"POST\">");
