package c407enumMapping.servlet;

import c407enumMapping.model.Employee407;
import c407enumMapping.model.EmployeeType;
import c407enumMapping.model.stateless.EmployeeService407;
...
public class EmployeeServlet407 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee407 emp = service.createEmployee(
            ...
            Collection<Employee407> emps = service.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee407 emp : emps) {
                    out.println(emp + "<br/>");
                }
            }
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet407\" method=\"POST\">");
