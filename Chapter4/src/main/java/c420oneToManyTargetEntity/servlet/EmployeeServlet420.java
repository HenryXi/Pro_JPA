package c420oneToManyTargetEntity.servlet;
...
import c420oneToManyTargetEntity.model.stateless.DepartmentService420;
import c420oneToManyTargetEntity.model.stateless.EmployeeService420;

public class EmployeeServlet420 extends HttpServlet {
    ...
    @EJB
    EmployeeService420 empService;
    @EJB
    DepartmentService420 deptService;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Collection<Employee420> emps = empService.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee420 emp : emps) {
                    out.println(emp + "<br/>");
                }
            }
            
            out.println("</br>");
            Collection<Department420> depts = deptService.findAllDepartments();
            if (depts.isEmpty()) {
                out.println("No Departments found ");
            } else {
                out.println("Found Departments: </br>");
                for (Department420 dept : depts) {
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet420\" method=\"POST\">");
