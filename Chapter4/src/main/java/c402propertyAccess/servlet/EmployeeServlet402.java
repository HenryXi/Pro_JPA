package c402propertyAccess.servlet;

import c402propertyAccess.model.Employee402;
import c402propertyAccess.model.stateless.EmployeeService402;
...
public class EmployeeServlet402 extends HttpServlet {
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet402\" method=\"POST\">");
