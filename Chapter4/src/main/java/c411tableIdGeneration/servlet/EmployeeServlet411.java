package c411tableIdGeneration.servlet;

import c411tableIdGeneration.model.Employee411;
import c411tableIdGeneration.model.stateless.EmployeeService411;
...
public class EmployeeServlet411 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee411 emp = service.createEmployee(
            ...
            Collection<Employee411> emps = service.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee411 emp : emps) {
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet411\" method=\"POST\">");
