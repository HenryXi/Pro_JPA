package c425embeddedObjects.servlet;

import c425embeddedObjects.model.Employee425;
import c425embeddedObjects.model.stateless.EmployeeService425;
...
public class EmployeeServiceServlet425 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Employee425 emp : service.findAllEmployees()) {
            out.print(emp + "<br/>");
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServiceServlet425\" method=\"POST\">");
