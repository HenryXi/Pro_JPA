...
import c414manyToOne.model.stateless.DepartmentService414;
import c414manyToOne.model.stateless.EmployeeService414;

public class EmployeeServlet414 extends HttpServlet {
    ...
    @EJB
    EmployeeService414 empService;
    @EJB
    DepartmentService414 deptService;
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet414\" method=\"POST\">");
