package c408temporalMapping.servlet;

import c408temporalMapping.model.Employee408;
import c408temporalMapping.model.stateless.EmployeeService408;
...
public class EmployeeServlet408 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee408 emp = service.createEmployee(
            ...
            Collection<Employee408> emps = service.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee408 emp : emps) {
                    out.println(emp + "<br/>");
                }
            }
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet408\" method=\"POST\">");
