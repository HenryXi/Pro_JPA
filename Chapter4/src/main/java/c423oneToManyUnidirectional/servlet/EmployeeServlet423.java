package c423oneToManyUnidirectional.servlet;
...
import c423oneToManyUnidirectional.model.stateless.EmployeeService423;
import c423oneToManyUnidirectional.model.stateless.PhoneService423;

public class EmployeeServlet423 extends HttpServlet {
    ...
    @EJB
    EmployeeService423 empService;
    @EJB
    PhoneService423 phoneService;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee423 emp = empService.createEmployee(
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet423\" method=\"POST\">");
