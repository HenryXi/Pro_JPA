package c422manyToManyJoinTable.servlet;
...
import c422manyToManyJoinTable.model.stateless.EmployeeService422;
import c422manyToManyJoinTable.model.stateless.ProjectService422;

public class EmployeeServlet422 extends HttpServlet {
    ...
    @EJB
    EmployeeService422 empService;
    @EJB
    ProjectService422 projService;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee422 emp = empService.createEmployee(
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet422\" method=\"POST\">");
