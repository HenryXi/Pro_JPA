package c424oneToOneLazy.servlet;
...
import c424oneToOneLazy.model.stateless.EmployeeService424;
import c424oneToOneLazy.model.stateless.ParkingSpaceService424;

public class EmployeeServlet424 extends HttpServlet {
    ...
    @EJB
    EmployeeService424 empService;
    @EJB
    ParkingSpaceService424 pSpaceService;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee424 emp = empService.createEmployee(
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet424\" method=\"POST\">");
