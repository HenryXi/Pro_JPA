package c406lobMapping.servlet;

import c406lobMapping.model.Employee406;
import c406lobMapping.model.stateless.EmployeeService406;
...
public class EmployeeServlet406 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            ...
            Employee406 emp = service.createEmployee(
            ...
            Collection<Employee406> emps = service.findAllEmployees();
            if (emps.isEmpty()) {
                out.println("No Employees found ");
            } else {
                out.println("Found Employees: </br>");
                for (Employee406 emp : emps) {
                    out.println(emp + "<br/>");
                }
            }
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet406\" method=\"POST\">");
