package c404customTableSchema.servlet;

import c404customTableSchema.model.Employee404;
import c404customTableSchema.model.stateless.EmployeeService404;
...
public class EmployeeServlet404 extends HttpServlet {
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet404\" method=\"POST\">");
