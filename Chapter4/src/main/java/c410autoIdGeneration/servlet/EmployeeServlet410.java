package c410autoIdGeneration.servlet;
...
import c410autoIdGeneration.model.stateless.EmployeeService410;

public class EmployeeServlet410 extends HttpServlet {
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServlet410\" method=\"POST\">");
