package c426sharingEmbeddedObjects.servlet;

import c426sharingEmbeddedObjects.model.Company426;
import c426sharingEmbeddedObjects.model.Employee426;
import c426sharingEmbeddedObjects.model.stateless.EmployeeService426;
...
public class EmployeeServiceServlet426 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Employee426 emp : service.findAllEmployees()) {
            out.print(emp + "<br/>");
        }
        
        out.println("<br/>Companies and Addresses: </br>");
        for (Company426 c : service.findAllCompanies()) {
            out.print(c + "<br/>");
        }
    ...
    private void printHtmlHeader(PrintWriter out) throws IOException {
        ...
        out.println("<hr/>");
        out.println("<form action=\"EmployeeServiceServlet426\" method=\"POST\">");
