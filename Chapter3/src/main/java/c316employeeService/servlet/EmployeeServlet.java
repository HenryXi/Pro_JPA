package c316employeeService.servlet;

import c316employeeService.model.Employee;
import c316employeeService.model.stateless.EmployeeService;
...
/**
 * this demo need create data source in glassfish.
 * the name of data source:jdbc/EmpServDB_ch3
 * do not forget config "<property name="eclipselink.ddl-generation" value="create-tables"/>" in persistence.xml file.
 */
